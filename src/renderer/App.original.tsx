...
const App: React.FC = () => {
  ...
  const handleEditorChange = (value: string | undefined) => {
    setStatus(prev => ({ 
      ...prev, 
      lastActivity: `Editing ${prev.editorMode.toLowerCase()} code`
    }));
  };
...
`}
          ...
          <div className='terminal-panel'>
            <div className='terminal-header'>
              ...
              <div className='terminal-controls'>
                <span className='terminal-info'>xterm.js</span>
              </div>
            </div>
            <TerminalComponent
              className='main-terminal'
              onTerminalReady={(terminalApi: any) => {
                setStatus(prev => ({ 
                  ...prev, 
                  lastActivity: 'Terminal ready' 
                }));
                if (window.electronAPI) {
                  window.electronAPI.logInfo('Terminal initialized');
                }
              }}
            />
          </div>
        ...
        <div className='browser-panel'>
          <div className='browser-header'>
            ...
            <div className='browser-controls'>
              ...
              >
                {status.yoloMode ? '🤖 YOLO ON' : '⏸️ YOLO OFF'}
              </button>
            </div>
          </div>
      ...
      <footer className='app-footer'>
        ...
        <p>Monaco Editor Integration • WebContentsView Browser • YOLO Mode Ready</p>
      </footer>
    </div>
  );
};
